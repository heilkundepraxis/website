  ...
  <div class="q-px-md">
    ...
    <section id="privacy">
      ...
      <ul class="q-pl-lg">
        ...
        <li>
          <a href="#beschwerde">Recht auf Beschwerde bei der zuständigen Aufsichtsbehörde</a>
        </li>
        <li>
          <a href="#datenuebertragbarkeit">Recht auf Datenübertragbarkeit</a>
        </li>
        <li>
          <a href="#auskunft">Recht auf Auskunft, Berichtigung, Sperrung und Löschung</a>
        </li>
        <li>
          <a href="#ssl">SSL- bzw. TLS-Verschlüsselung</a>
        </li>
        <li>
          <a href="#logs">Server-Log-Dateien</a>
        </li>
        <li>
    ...
    <section id="beschwerde">
      ...
      <p>
        ...
        stellt eine Liste der Datenschutzbeauftragten sowie deren Kontaktdaten bereit: <a
          href="https://www.bfdi.bund.de" target="_blank">bfdi.bund.de</a>
      </p>
    </section>

    <section id="datenuebertragbarkeit">
    ...
    <section id="auskunft">
      <h2>Recht auf Auskunft, Berichtigung, Sperrung und Löschung</h2>
